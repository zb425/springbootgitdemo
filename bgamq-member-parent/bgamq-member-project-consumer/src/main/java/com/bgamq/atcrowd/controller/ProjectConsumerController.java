...
import com.bgamq.atcrowd.config.OSSProperties;
import com.bgamq.atcrowd.constant.CrowdConstant;
import com.bgamq.atcrowd.util.CrowdUtil;
...
public class ProjectConsumerController {
    ...
    public String getProjectDetail(@PathVariable("projectId") Integer projectId, Model model) {
        ...
        if(ResultEntity.SUCCESS.equals(resultEntity.getResult())) {
            ...
            model.addAttribute("detailProject", detailProjectVO);
        }
    ...
    public String saveProjectBasicInfo(// 接收除了上传图片之外的其他普通数据
                                       ProjectVO projectVO,
                                       // 接收上传的头图
